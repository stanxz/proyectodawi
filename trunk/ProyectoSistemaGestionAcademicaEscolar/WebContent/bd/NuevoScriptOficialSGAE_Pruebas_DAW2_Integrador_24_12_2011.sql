...
CREATE TABLE `aca` (
  `CODACA` varchar(11) NOT NULL,
  PRIMARY KEY (`CODACA`),
  CONSTRAINT `fk_ACA_persona1` FOREIGN KEY (`CODACA`) REFERENCES `persona` (`CODPERSONA`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ada` (
  `CODADA` varchar(11) NOT NULL,
  PRIMARY KEY (`CODADA`),
  CONSTRAINT `fk_evaluador_persona1` FOREIGN KEY (`CODADA`) REFERENCES `persona` (`CODPERSONA`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `alumno` (`CODALUMNO`, `CODAPODERADO`, `NOMBRES`, `APELLIDOPAT`, `APELLIDOMAT`, `FECNAC`, `ESTADO`, `SEXO`, `DNI`, `IDDISTRITO`) VALUES ('AL-25365475','PE-33333333','Juan Manuel','Vargas','Nosequemas','1998-03-11 00:00:00','MATRICULADO',0,25365475,44),('AL-30303030','PE-18181818','Lionelo','Messi','Caraccitti','2011-11-25 00:00:00','MATRICULADO',1,30303030,2),('AL-88745521','PE-11111111','Ian','Van Dahl','Quispe','2000-05-10 00:00:00','MATRICULADO',1,88745521,7);
...
INSERT INTO `apoderado` (`CODAPODERADO`) VALUES ('PE-10101010'),('PE-11111111'),('PE-18181818'),('PE-33333333'),('PE-44853428'),('PE-88888888');
...
INSERT INTO `asignatura` (`CODASIGNATURA`, `NOMBRE`, `ESTADO`, `GRADO`) VALUES (1,'Matematica 1','Deshabilitado',3),(2,'idioma','Habilitado',4),(3,'lengua','Habilitado',7),(4,'mate','Habilitado',9);
...
INSERT INTO `boletapago` (`CODBOLETA`, `CODAPODERADO`, `FECHAREGISTRO`, `MONTO`, `ESTADO`, `TIPOSOLICITUD`) VALUES ('123456','PE-18181818','2011-12-24',150,'CANCELADO','RETIRO');
...
CREATE TABLE `certificadoas` (
  ...
  `ESTADO` varchar(15) DEFAULT NULL,
  `CONTENIDODOCCERT` blob,
  `DOCENVIADO` int(11) DEFAULT NULL,
  `motivo_CODMOTIVO` int(11) NOT NULL,
  PRIMARY KEY (`CODCERTIFICADO`),
  KEY `CERTIFICADOAS_CITA_FK` (`CODCITA`),
  KEY `fk_certificadoas_motivo1` (`motivo_CODMOTIVO`),
  CONSTRAINT `CERTIFICADOAS_CITA_FK` FOREIGN KEY (`CODCITA`) REFERENCES `cita` (`CODCITA`),
  CONSTRAINT `fk_certificadoas_motivo1` FOREIGN KEY (`motivo_CODMOTIVO`) REFERENCES `motivo` (`CODMOTIVO`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `matricula` (
  ...
  `noReligion` int(11) DEFAULT NULL,
  `noEF` int(11) DEFAULT NULL,
...
INSERT INTO `matricula` (`idmatricula`, `CODALUMNO`, `idseccionprogramada`, `CODCALENDARIO`, `fechamat`, `noReligion`, `noEF`) VALUES (1,'AL-25365475',23,'2011','2011-12-14',NULL,NULL),(2,'AL-88745521',29,'2011','2011-12-22',0,0);
...
INSERT INTO `motivo` (`CODMOTIVO`, `NOMBRE`) VALUES (1,'SALUD'),(2,'ECONOMICO/FAMILIAR');
...
INSERT INTO `persona` (`CODPERSONA`, `NOMBRES`, `APELLIDOPAT`, `APELLIDOMAT`, `DIRECCION`, `EMAIL`, `TELEFONO`, `CELULAR`, `SEXO`, `DNI`, `IDDISTRITO`) VALUES ('PE-00000001','Rhandy','Muguruza','Vega','mi casa 765','rmuguruza19@gmail.com','655-4305','972703720',1,1,39),('PE-10101010','Jorge','Rojas','De la Cruz','mi casa 235','rmuguruza19@gmail.com','346-7554','345678990',1,10101010,1),('PE-11111111','Rodrigo','Berrospi','Gutierrez',NULL,'rmberrospig@gmail.com',NULL,NULL,1,11111111,2),('PE-12121212','Carlos','Mendez','Nosequemas',NULL,'angelogaceto6@hotmail.com',NULL,NULL,1,12121212,3),('PE-13131313','Joe','Guere','Sandioma',NULL,'geraldine85_13@hotmail.com',NULL,NULL,1,13131313,4),('PE-14141414','Adolfo','Gutierrez','Toguchi',NULL,'rmberrospig@gmail.com',NULL,NULL,1,14141414,5),('PE-15151515','Gianina','Lujan','Zavaleta',NULL,'jotali333_3@hotmail.com',NULL,NULL,0,15151515,6),('PE-16161616','Catalina','Gomez','Paredes',NULL,'rmuguruza19@gmail.com',NULL,NULL,0,16161616,7),('PE-17171717','Raul','Fernandez','Ambolaya',NULL,'jean333_3@hotmail.com',NULL,NULL,1,17171717,8),('PE-18181818','Juan','Vivanco','Fernandez',NULL,'freddy_16512@hotmail.com',NULL,NULL,1,18181818,9),('PE-19191919','Juan','Perez','Lopez',NULL,'I710089@cibertec.edu.pe',NULL,NULL,1,19191919,10),('PE-20202020','Rhandy','Muguruza','Vega','Coop Magdalena Mz C Lote 9 ','rmuguruza19@gmail.com','5555555','999999999',1,20202020,11),('PE-22222222','Carlos','Alcantara','Villavicencio',NULL,'geraldine8513@gmail.com',NULL,NULL,1,22222222,12),('PE-33333333','Pedro','Castillo','Ascencios',NULL,'I710089@cibertec.edu.pe',NULL,NULL,1,33333333,13),('PE-44444444','Ariadna','Ramos','De la Cruz',NULL,'rmberrospig@gmail.com',NULL,NULL,0,44444444,14),('PE-44853428','Rhandy','Muguruza','Vega','asdgasd g785','rmuguruza19@gmail.com','465-4633','654978561',1,44853428,47),('PE-55555555','Brenda','Rey','Pacherres',NULL,'yanet.susanivar@gmail.com',NULL,NULL,0,55555555,15),('PE-66666666','Marilda','Lumbre','Mayuri',NULL,'rmberrospig@gmail.com',NULL,NULL,0,66666666,16),('PE-77777777','Vilma','Cardenas','Narro',NULL,'geraldine8513@gmail.com',NULL,NULL,0,77777777,17),('PE-88888888','Edinso','Goicochea','Ascencios',NULL,'luz.guelac@gmail.com',NULL,NULL,1,88888888,18),('PE-99999999','Yaneth','Susanivar','Porras',NULL,'yanet.susanivar@gmail.com',NULL,NULL,0,99999999,19);
...
INSERT INTO `seccionprogramada` (`idseccionprogramada`, `grado`, `seccion`, `nivel`) VALUES (1,1,'A','PRIMARIA'),(2,1,'B','PRIMARIA'),(3,1,'C','PRIMARIA'),(4,2,'A','PRIMARIA'),(5,2,'B','PRIMARIA'),(6,2,'C','PRIMARIA'),(7,3,'A','PRIMARIA'),(8,3,'B','PRIMARIA'),(9,3,'C','PRIMARIA'),(10,4,'A','PRIMARIA'),(11,4,'B','PRIMARIA'),(12,4,'C','PRIMARIA'),(13,5,'A','PRIMARIA'),(14,5,'B','PRIMARIA'),(15,5,'C','PRIMARIA'),(16,6,'A','PRIMARIA'),(17,6,'B','PRIMARIA'),(18,6,'C','PRIMARIA'),(19,7,'A','SECUNDARIA'),(20,7,'B','SECUNDARIA'),(21,7,'C','SECUNDARIA'),(22,8,'A','SECUNDARIA'),(23,8,'B','SECUNDARIA'),(24,8,'C','SECUNDARIA'),(25,9,'A','SECUNDARIA'),(26,9,'B','SECUNDARIA'),(27,9,'C','SECUNDARIA'),(28,10,'A','SECUNDARIA'),(29,10,'B','SECUNDARIA'),(30,10,'C','SECUNDARIA'),(31,11,'A','SECUNDARIA'),(32,11,'B','SECUNDARIA'),(33,11,'C','SECUNDARIA');
...
CREATE TABLE `solicitudexoneracion` (
  ...
  CONSTRAINT `fk_solicitudexoneracion_ACA1` FOREIGN KEY (`CODACA`) REFERENCES `aca` (`CODACA`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `solicitudretiro` (
  ...
  CONSTRAINT `fk_solicitudretiro_ADA1` FOREIGN KEY (`CODADA`) REFERENCES `ada` (`CODADA`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2011-12-24 20:36:32
