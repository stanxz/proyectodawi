...
CREATE TABLE `ADA` (
  `CODPERSONA` VARCHAR(11) NOT NULL ,
  PRIMARY KEY (`CODPERSONA`) ,
  CONSTRAINT `fk_evaluador_persona1`
    FOREIGN KEY (`CODPERSONA` )
    REFERENCES `persona` (`CODPERSONA` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
INSERT INTO `apoderado` (`CODAPODERADO`) VALUES ('PE-10101010'),('PE-11111111'),('PE-12121212'),('PE-17171717'),('PE-18181818'),('PE-22222222'),('PE-33333333'),('PE-55555555'),('PE-88888888');
...
CREATE  TABLE IF NOT EXISTS `matricula` (
  `CODALUMNO` VARCHAR(11) NOT NULL ,
  `idseccionprogramada` INT NOT NULL ,
  `CODCALENDARIO` CHAR(4) NOT NULL ,
  `fechamat` VARCHAR(45) NULL ,
  PRIMARY KEY (`CODALUMNO`, `idseccionprogramada`, `CODCALENDARIO`) ,
  INDEX `fk_alumno_has_seccionprogramada_seccionprogramada1` (`idseccionprogramada` ASC) ,
  INDEX `fk_alumno_has_seccionprogramada_alumno1` (`CODALUMNO` ASC) ,
  INDEX `fk_matricula_calendarioacademico1` (`CODCALENDARIO` ASC) ,
  CONSTRAINT `fk_alumno_has_seccionprogramada_alumno1`
    FOREIGN KEY (`CODALUMNO` )
    REFERENCES `alumno` (`CODALUMNO` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_alumno_has_seccionprogramada_seccionprogramada1`
    FOREIGN KEY (`idseccionprogramada` )
    REFERENCES `seccionprogramada` (`idseccionprogramada` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_matricula_calendarioacademico1`
    FOREIGN KEY (`CODCALENDARIO` )
    REFERENCES `calendarioacademico` (`CODCALENDARIO` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
INSERT INTO `perfil` (`CODPERFIL`, `NOMBRE`, `DESCRIPCION`) VALUES ('pf01','Apoderado','Persona responsable de un determinado alumno de la InstituciÃ³n Educativa'),('pf02','Asistenta Social','Persona encargada de brindar apoyo  social a los alumnos de la instituciÃ³n'),('pf03','Secretaria','Persona encargada la evaluaciÃ³n de tramites de la InstituciÃ³n Educativa'),('pf04','No asignado','No asignado'),('pf05','GerenteGeneral','Persona que visualiza los reportes'),('pf06','Administrador','Persona con privilegios para usar los amntenimientos');
...
-- Table `bd_proy_sgae`.`seccionprogramada`
...
CREATE  TABLE `seccionprogramada` (
  `idseccionprogramada` INT NOT NULL AUTO_INCREMENT ,
  `grado` INT NULL ,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE  TABLE IF NOT EXISTS `solicitudexoneracion` (
  ...
  `FLAGPROCESADO` INT NULL ,
  `CODACA` VARCHAR(11) NULL ,
  ...
  INDEX `fk_solicitudexoneracion_ACA1` (`CODACA` ASC) ,
  ...
  CONSTRAINT `fk_solicitudexoneracion_ACA1`
    FOREIGN KEY (`CODACA` )
    REFERENCES `ACA` (`CODPERSONA` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
CREATE  TABLE `solicitudretiro` (
  ...
  INDEX `fk_solicitudretiro_ADA1` (`CODADA` ASC) ,
  CONSTRAINT `SOLICITUDRETIRO_ALUMNO_FK`
    FOREIGN KEY (`CODALUMNO` )
    REFERENCES `alumno` (`CODALUMNO` ),
  CONSTRAINT `SOLICITUDRETIRO_CERTIFICADOAS_FK`
    FOREIGN KEY (`CODCERTIFICADO` )
    REFERENCES `certificadoas` (`CODCERTIFICADO` ),
  CONSTRAINT `fk_solicitudretiro_ADA1`
    FOREIGN KEY (`CODADA` )
    REFERENCES `ADA` (`CODPERSONA` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
INSERT INTO `usuario` (`IDLOGIN`, `CODPERSONA`, `CODPERFIL`, `CONTRASENA`) VALUES (20,'PE-14141414','pf02','14141414'),(21,'PE-55555555','pf02','55555555'),(22,'PE-13131313','pf02','13131313'),(23,'PE-18181818','pf01','18181818'),(24,'PE-66666666','pf02','66666666'),(25,'PE-17171717','pf01','17171717'),(26,'PE-12121212','pf01','12121212'),(27,'PE-55555555','pf01','55555555'),(28,'PE-22222222','pf01','22222222'),(29,'PE-88888888','pf01','88888888'),(30,'PE-10101010','pf01','10101010'),(31,'PE-11111111','pf01','11111111'),(32,'PE-33333333','pf01','33333333'),(33,'PE-44444444','pf03','44444444'),(34,'PE-16161616','pf03','16161616'),(35,'PE-99999999','pf03','99999999'),(36,'PE-15151515','pf03','15151515'),(37,'PE-18181818','pf04','18181818'),(38,'PE-77777777','pf03','77777777'),(39,'PE-20202020','pf05','20202020');
...
-- Dump completed on 2011-12-07 17:33:31
