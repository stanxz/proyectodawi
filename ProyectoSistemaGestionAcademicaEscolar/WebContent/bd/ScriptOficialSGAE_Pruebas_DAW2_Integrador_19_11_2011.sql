...
INSERT INTO `perfil` (`CODPERFIL`, `NOMBRE`, `DESCRIPCION`) VALUES ('pf01','Apoderado','Persona responsable de un determinado alumno de la Institución Educativa'),('pf02','Asistenta Social','Persona encargada de brindar apoyo  social a los alumnos de la institución'),('pf03','Secretaria','Persona encargada la evaluación de tramites de la Institución Educativa'),('pf04','No asignado','No asignado'),('pf05','GerenteGeneral','Persona que visualiza los reportes'),('pf06','Administrador','Persona con privilegios para usar los amntenimientos');
