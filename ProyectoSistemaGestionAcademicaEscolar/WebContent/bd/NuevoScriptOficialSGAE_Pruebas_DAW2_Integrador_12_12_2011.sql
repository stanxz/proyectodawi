...
INSERT INTO `alumno` VALUES ('AL-21235534','PE-11111111','jfdghdfh','gdjdj','dsfhdfh','2000-01-19 00:00:00','MATRICULADO',0,21235534,44),('AL-30303030','PE-18181818','Lionelo','Messi','Caraccitti','2011-11-25 00:00:00','MATRICULADO',1,30303030,2);
...
INSERT INTO `apoderado` VALUES ('PE-10101010'),('PE-11111111'),('PE-18181818'),('PE-33333333'),('PE-44853428'),('PE-88888888');
...
INSERT INTO `asignatura` VALUES (1,'Matematica 1','Deshabilitado',3);
...
INSERT INTO `calendarioacademico` VALUES ('2011');
...
INSERT INTO `detalleperfil` VALUES ('pm01','pf01'),('pm02','pf01'),('pm03','pf01'),('pm04','pf02'),('pm07','pf03'),('pm09','pf03'),('pm10','pf05'),('pm07','pf06'),('pm08','pf06'),('pm09','pf06'),('pm06','pf07'),('pm05','pf08');
...
-- Dump completed on 2011-12-14 17:44:13
